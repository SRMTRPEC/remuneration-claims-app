            ...
            <div className="border border-black/5 rounded-md p-4">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  ...
                  <Microscope size={16} className="text-teal-500" />
                  <span className="font-semibold text-brand-primary">Practical Squad</span>
                </div>
              ...
              {formData.practical_squad_enabled && (
                <div className="mt-4 pl-7 flex flex-col gap-1 w-1/2">
                  ...
                  <input type="number" name="practical_squad_sessions" value={formData.practical_squad_sessions} onChange={handleChange} placeholder="Sessions (₹150 each)" className="bg-neutral-surface border border-black/5 rounded-md px-4 py-2 text-sm" />
                </div>
              )}
            </div>
